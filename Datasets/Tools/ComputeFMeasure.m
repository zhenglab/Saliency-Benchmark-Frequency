%CVBIOUC% function [Results]=ComputeFMeasure(DBpath,SegResultsSubPath,SysType)
function ComputeFMeasure(DBpath,SysType)
...
mask=mask>=2;
imwrite(mask,strcat('./1obj_GroundTruth/',GTname,'.png')); %CVBIOUC%
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
